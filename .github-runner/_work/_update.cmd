...
set rootfolder=D:\projects\philips\satmeup\.github-runner
set existrunnerversion=2.311.0
set downloadrunnerversion=2.323.0
set logfile=D:\projects\philips\satmeup\.github-runner\_diag\SelfUpdate-20250514-065614.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "D:\projects\philips\satmeup\.github-runner\run.cmd"
) else (
  endlocal
)
